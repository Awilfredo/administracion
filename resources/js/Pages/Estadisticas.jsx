    ...
    useEffect(() => {
        if (data.length > 0) {
            ...
            timestamps.forEach((fecha) => {
                ...
                if (suma_elementos > 0) {
                    dia_elemnto.horas = suma_horas>0 ? ((suma_horas / suma_elementos) / 3600).toFixed(2): null;
                    dia_elemnto.horas_huella = suma_huella > 0 ? ((suma_huella / suma_elementos) / 3600).toFixed(2): null;
                    datos_grafica.push({
